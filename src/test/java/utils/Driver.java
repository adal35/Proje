...
public class Driver {
    ...
    public static final String propertyPath = "./src/test/resources/configurations/configurations.properties";
    ...
    //initialize our chrome driver capabilities
    public static WebDriver getRemoteDriver() {

        WebDriver driver = null;
        try {
            DesiredCapabilities capabilities = DesiredCapabilities.chrome(); // use switch statement to include other browsers
